...
<template>
    <div>
        ...
        <div class="relative dark:bg-dark-secondary dark:text-white">
            <div
                class="wrapper max-w-[1000px] mx-auto "
            >
                <div class="page">
                    <div class="">
                        <div class="row">
                            <div class="space-y-4">
                                <h1>
                                    Privacy Policy for Ethiopian Youth
                                    Entrepreneurs Association
                                </h1>
                                <p>
                                    At EYEA, accessible from
                                    ...
                                    is collected and recorded by EYEA and how we
                                    use it.
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    in EYEA. This policy is not applicable to
                                ...
                                <h2>Log Files</h2>
                                <p>
                                    EYEA follows a standard procedure of using
                                ...
                                <p>
                                    Like any other website, EYEA uses "cookies".
                                    These cookies are used to store information
                                    including visitors' preferences, and the
                                    pages on the website that the visitor
                                    accessed or visited. The information is used
                                    to optimize the users' experience by
                                ...
                                <p>
                                    ...
                                    appear on EYEA, which are sent directly to
                                ...
                                <p>
                                    Note that EYEA has no access to or control
                                    over these cookies that are used by
                                    third-party advertisers.
                                </p>
                                <h2>Third Party Privacy Policies</h2>
                                <p>
                                    EYEA's Privacy Policy does not apply to
                                ...
                                <p>
                                    EYEA does not knowingly collect any Personal
                                    Identifiable Information from children under
                                    the age of 13. If you think that your child
                                    provided this kind of information on our
                                    website, we strongly encourage you to
                                    contact us immediately and we will do our
                                    best efforts to promptly remove such
                                    information from our records.
                                </p>
                                <h2>Changes to This Privacy Policy</h2>
                                <p>
                                    We may update our Privacy Policy from time
                                    to time. Thus, we advise you to review this
                                ...
                                <p>
                                    Our Privacy Policy was created with the help
                                    of the
                                    <a
